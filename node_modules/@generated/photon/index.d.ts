...
declare type ArticleGetSelectPayload<S extends boolean | ArticleSelect> = S extends true ? Article : S extends ArticleSelect ? {
    [P in CleanupNever<MergeTruthyValues<{}, S>>]: P extends ArticleScalars ? Article[P] : P extends 'creator' ? Array<UserGetSelectPayload<ExtractFindManyUserSelectArgs<S[P]>>> : P extends 'categories' ? Array<CategoryGetSelectPayload<ExtractFindManyCategorySelectArgs<S[P]>>> : never;
} : never;
declare type ArticleGetIncludePayload<S extends boolean | ArticleInclude> = S extends true ? Article : S extends ArticleInclude ? {
    [P in CleanupNever<MergeTruthyValues<ArticleDefault, S>>]: P extends ArticleScalars ? Article[P] : P extends 'creator' ? Array<UserGetIncludePayload<ExtractFindManyUserIncludeArgs<S[P]>>> : P extends 'categories' ? Array<CategoryGetIncludePayload<ExtractFindManyCategoryIncludeArgs<S[P]>>> : never;
} : never;
