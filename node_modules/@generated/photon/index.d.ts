...
export declare type UserScalars = 'id' | 'username' | 'password';
...
declare type UserGetSelectPayload<S extends boolean | UserSelect> = S extends true ? User : S extends UserSelect ? {
    [P in CleanupNever<MergeTruthyValues<{}, S>>]: P extends UserScalars ? User[P] : P extends 'articles' ? Array<ArticleGetSelectPayload<ExtractFindManyArticleSelectArgs<S[P]>>> : never;
} : never;
declare type UserGetIncludePayload<S extends boolean | UserInclude> = S extends true ? User : S extends UserInclude ? {
    [P in CleanupNever<MergeTruthyValues<UserDefault, S>>]: P extends UserScalars ? User[P] : P extends 'articles' ? Array<ArticleGetIncludePayload<ExtractFindManyArticleIncludeArgs<S[P]>>> : never;
} : never;
...
declare type ArticleGetSelectPayload<S extends boolean | ArticleSelect> = S extends true ? Article : S extends ArticleSelect ? {
    [P in CleanupNever<MergeTruthyValues<{}, S>>]: P extends ArticleScalars ? Article[P] : P extends 'creator' ? UserGetSelectPayload<ExtractUserSelectArgs<S[P]>> : P extends 'categories' ? Array<CategoryGetSelectPayload<ExtractFindManyCategorySelectArgs<S[P]>>> : never;
} : never;
declare type ArticleGetIncludePayload<S extends boolean | ArticleInclude> = S extends true ? Article : S extends ArticleInclude ? {
    [P in CleanupNever<MergeTruthyValues<ArticleDefault, S>>]: P extends ArticleScalars ? Article[P] : P extends 'creator' ? UserGetIncludePayload<ExtractUserIncludeArgs<S[P]>> : P extends 'categories' ? Array<CategoryGetIncludePayload<ExtractFindManyCategoryIncludeArgs<S[P]>>> : never;
} : never;
export interface ArticleDelegate {
    <T extends FindManyArticleArgs>(args?: Subset<T, FindManyArticleArgs>): T extends FindManyArticleArgsRequired ? 'Please either choose `select` or `include`' : T extends FindManyArticleSelectArgs ? Promise<Array<ArticleGetSelectPayload<ExtractFindManyArticleSelectArgs<T>>>> : T extends FindManyArticleIncludeArgs ? Promise<Array<ArticleGetIncludePayload<ExtractFindManyArticleIncludeArgs<T>>>> : Promise<Array<Article>>;
    findOne<T extends FindOneArticleArgs>(args: Subset<T, FindOneArticleArgs>): T extends FindOneArticleArgsRequired ? 'Please either choose `select` or `include`' : T extends FindOneArticleSelectArgs ? Promise<ArticleGetSelectPayload<ExtractFindOneArticleSelectArgs<T>>> : T extends FindOneArticleIncludeArgs ? Promise<ArticleGetIncludePayload<ExtractFindOneArticleIncludeArgs<T>>> : ArticleClient<Article>;
...
export declare class ArticleClient<T> implements Promise<T> {
    ...
    constructor(_dmmf: DMMFClass, _fetcher: PhotonFetcher, _queryType: 'query' | 'mutation', _rootField: string, _clientMethod: string, _args: any, _path: string[], _isList?: boolean);
    readonly [Symbol.toStringTag]: 'PhotonPromise';
    creator<T extends UserArgs = {}>(args?: Subset<T, UserArgs>): T extends FindOneUserArgsRequired ? 'Please either choose `select` or `include`' : T extends UserSelectArgs ? Promise<UserGetSelectPayload<ExtractUserSelectArgs<T>>> : T extends UserIncludeArgs ? Promise<UserGetIncludePayload<ExtractUserIncludeArgs<T>>> : UserClient<User>;
...
declare type CategoryGetSelectPayload<S extends boolean | CategorySelect> = S extends true ? Category : S extends CategorySelect ? {
    [P in CleanupNever<MergeTruthyValues<{}, S>>]: P extends CategoryScalars ? Category[P] : P extends 'articles' ? Array<ArticleGetSelectPayload<ExtractFindManyArticleSelectArgs<S[P]>>> : never;
} : never;
declare type CategoryGetIncludePayload<S extends boolean | CategoryInclude> = S extends true ? Category : S extends CategoryInclude ? {
    [P in CleanupNever<MergeTruthyValues<CategoryDefault, S>>]: P extends CategoryScalars ? Category[P] : P extends 'articles' ? Array<ArticleGetIncludePayload<ExtractFindManyArticleIncludeArgs<S[P]>>> : never;
} : never;
export interface CategoryDelegate {
    <T extends FindManyCategoryArgs>(args?: Subset<T, FindManyCategoryArgs>): T extends FindManyCategoryArgsRequired ? 'Please either choose `select` or `include`' : T extends FindManyCategorySelectArgs ? Promise<Array<CategoryGetSelectPayload<ExtractFindManyCategorySelectArgs<T>>>> : T extends FindManyCategoryIncludeArgs ? Promise<Array<CategoryGetIncludePayload<ExtractFindManyCategoryIncludeArgs<T>>>> : Promise<Array<Category>>;
    findOne<T extends FindOneCategoryArgs>(args: Subset<T, FindOneCategoryArgs>): T extends FindOneCategoryArgsRequired ? 'Please either choose `select` or `include`' : T extends FindOneCategorySelectArgs ? Promise<CategoryGetSelectPayload<ExtractFindOneCategorySelectArgs<T>>> : T extends FindOneCategoryIncludeArgs ? Promise<CategoryGetIncludePayload<ExtractFindOneCategoryIncludeArgs<T>>> : CategoryClient<Category>;
...
export declare type UserUpsertWithoutArticlesInput = {
    update: UserUpdateWithoutArticlesDataInput;
    create: UserCreateWithoutArticlesInput;
};
export declare type UserUpdateOneRequiredWithoutArticlesInput = {
    create?: UserCreateWithoutArticlesInput | null;
    connect?: UserWhereUniqueInput | null;
...
export declare type ArticleUpdateInput = {
    ...
    title?: string | null;
    url?: string | null;
    creator?: UserUpdateOneRequiredWithoutArticlesInput | null;
    categories?: CategoryUpdateManyWithoutArticlesInput | null;
};
